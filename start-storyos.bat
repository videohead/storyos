...
echo ============================================================
echo StoryOS startup and verification
echo ============================================================
...
echo.
echo [STEP 3/3] Starting Lando in local StoryOS directory...
pushd "%ROOT_DIR%"
lando start
if errorlevel 1 (
    echo ERROR: Lando failed to start the StoryOS site.
    popd
    exit /b 1
)
lando info
...
echo StoryOS Lando site: check 'lando info'
exit /b 0
