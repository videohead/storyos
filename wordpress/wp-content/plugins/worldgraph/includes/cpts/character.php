...
class Character {
	...
	public static function save_meta( int $post_id, \WP_Post $post ): void {
		if ( ! isset( $_POST['worldgraph_character_nonce'] ) || ! wp_verify_nonce( $_POST['worldgraph_character_nonce'], 'worldgraph_character_details' ) ) {
			return;
		}
		...
		$fields = \WorldGraph\Utils\worldgraph_get_fields( 'worldgraph_character' );
