<?php
/**
 * Organizations REST API Controller for World Graph Studio.
 *
 * @package WorldGraph
 */
...
class Organizations_Controller extends Base_Controller {
	 ...
	 * @var string
	 */
	protected $rest_base = 'organizations';
	...
	public function register_routes() {
		register_rest_route( 'worldgraph/v1', '/organizations', [
			[
				'methods'             => 'GET',
		...
		register_rest_route( 'worldgraph/v1', '/organizations/(?P<id>\d+)', [
		...
		register_rest_route( 'worldgraph/v1', '/organizations/(?P<id>\d+)/graph', [
			'methods'             => 'GET',
	...
	public static function get_graph( \WP_REST_Request $request ) {
		...
		$entities = \WorldGraph\Utils\get_graph_entities( $post_id, 'worldgraph_org' );
