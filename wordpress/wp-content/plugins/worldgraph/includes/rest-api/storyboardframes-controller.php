<?php
/**
 * Storyboard Frames REST API Controller for World Graph Studio.
 *
 * @package WorldGraph
 */
...
class StoryboardFrames_Controller extends Base_Controller {
	 ...
	 * @var string
	 */
	protected $cpt = 'worldgraph_board';
	...
	public function register_routes() {
		register_rest_route( 'worldgraph/v1', '/storyboard-frames', [
			[
				'methods'             => 'GET',
		...
		register_rest_route( 'worldgraph/v1', '/storyboard-frames/(?P<id>\d+)', [
		...
		register_rest_route( 'worldgraph/v1', '/storyboard-frames/(?P<id>\d+)/graph', [
			'methods'             => 'GET',
	...
	public static function get_graph( \WP_REST_Request $request ) {
		...
		$entities = \WorldGraph\Utils\get_graph_entities( $post_id, 'worldgraph_board' );
