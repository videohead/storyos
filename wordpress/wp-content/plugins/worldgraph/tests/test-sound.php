<?php
/**
 * Tests for the World Graph Studio Sound framework.
 *
 * @package WorldGraph
 */
 ...
 */
class Test_WorldGraph_Sound extends TestCase {
	...
	public function test_sound_relationship_contract() {
		...
		$this->assertStringContainsString( "'related_cpt'       => 'worldgraph_scene'", $sound );
		$this->assertStringContainsString( "'related_cpt'       => 'worldgraph_shot'", $sound );
		$this->assertStringContainsString( "'related_cpt'       => 'worldgraph_character'", $sound );
		$this->assertStringContainsString( "'related_cpt'       => 'worldgraph_asset'", $sound );
	...
	public function test_sound_rest_controller_uses_instance_callbacks_and_filters() {
		...
		$this->assertStringContainsString( 'worldgraph_is_audio_asset', $controller );
	}
