...
namespace StoryOSWebStories\API;
...
class Client {
	...
	public static function get_stories( array $args = [] ) {
		...
		if ( ! is_array( $data ) ) {
			return new \WP_Error( 'invalid_response', __( 'Invalid response from Web Stories API.', 'storyos-web-stories' ) );
		}
	...
	/**
	 * Create a Web Story from StoryOS scene data.
	 *
