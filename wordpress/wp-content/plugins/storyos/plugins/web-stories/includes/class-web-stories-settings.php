...
class Settings {
	 ...
	 * @var string
	 */
	private $page_slug = 'storyos-web-stories-settings';
	 ...
	 * @var string
	 */
	private $option_name = 'storyos_web_stories_settings';
	...
	private function __construct() {
		...
		add_filter( 'plugin_action_links_' . STORYOS_WEB_STORIES_PLUGIN_BASE, [ $this, 'add_plugin_links' ] );
	}
	...
	public function register_settings(): void {
		...
		add_settings_field(
			...
			[
				'field'  => 'sync_enabled',
				'label'  => 'Enable synchronization between StoryOS and Web Stories',
				'default' => false,
			]
		);
		...
		add_settings_field(
			...
			[
				...
				'options' => [
					...
					'storyos_to_web' => 'StoryOS to Web Stories only',
					'web_to_storyos' => 'Web Stories to StoryOS only',
				],
	...
	public function render_sync_section(): void {
		echo '<p>Configure how StoryOS and Web Stories synchronize.</p>';
	}
	...
	public function sanitize_settings( array $input ): array {
		...
		// Select fields.
		$select_fields = [
			'sync_direction'  => [ 'bidirectional', 'storyos_to_web', 'web_to_storyos' ],
