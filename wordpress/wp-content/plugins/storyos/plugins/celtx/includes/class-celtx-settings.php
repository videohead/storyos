...
class Settings {
	...
	public function render_settings_page(): void {
		...
		<div class="wrap">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							...
							/>
							<p class="description">
								The Celtx Project ID to sync StoryOS elements to. Leave empty to sync to a default project.
							</p>
						</td>
					</tr>
					<tr>
						...
						<td>
							<label>
								<input 
									...
									name="celtx_enabled" 
									value="1"
									<?php checked( \StoryOSCeltx\Settings::is_enabled() ); ?>
								/>
								<span class="dashicons dashicons-yes" style="color: #46b450; margin-right: 4px;"></span>
								Enable Celtx synchronization
							</label>
							<p class="description">
								When enabled, StoryOS elements will automatically sync to Celtx. Disable this to pause synchronization without removing your API credentials.
							</p>
						</td>
					</tr>
				</table>
			...
			<p>The Celtx Sync plugin synchronizes StoryOS elements with Celtx elements:</p>
			<ul>
			...
			<p>Each StoryOS element stores its corresponding Celtx element ID in post meta for bidirectional sync.</p>
		</div>
		<?php
	}
