...
## Overview
This plugin enables importing and exporting Edit Decision List (EDL) files from StoryOS projects and episodes. Compatible with CMX 3600 (ASCII) and SMPTE 436m (XML) EDL formats.
...
<smpte:edl xmlns:smpte="urn:smpte:umid:1.0">
  <smpte:header>
    <smpte:title>StoryOS EDL</smpte:title>
  ...
  <smpte:body>
    <smpte:event>
      ...
      <smpte:component>
        ...
        <smpte:authority>StoryOS</smpte:authority>
...
- **Missing Clips**: Check that source media is available in StoryOS
