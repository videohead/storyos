<?php
/**
 * Organizations REST API Controller for StoryOS.
 *
 * @package StoryOS
 */
...
class Organizations_Controller extends Base_Controller {
	 ...
	 * @var string
	 */
	protected $cpt = 'storyos_organization';
	...
	public function register_routes() {
		register_rest_route( 'storyos/v1', '/organizations', [
			[
				'methods'             => 'GET',
		...
		register_rest_route( 'storyos/v1', '/organizations/(?P<id>\d+)', [
		...
		register_rest_route( 'storyos/v1', '/organizations/(?P<id>\d+)/graph', [
			'methods'             => 'GET',
	...
	public static function get_graph( \WP_REST_Request $request ) {
		...
		$entities = \StoryOS\Utils\get_graph_entities( $post_id, 'storyos_organization' );
