...
class Plugins {
	...
	public static function render_plugins_page(): void {
		...
		<div class="wrap storyos-plugins">
			...
			<p>Adapters load on demand when an enabled Connection uses them. Manage activation and credentials from <a href="<?php echo esc_url( admin_url( 'admin.php?page=storyos-connections' ) ); ?>">StoryOS &gt; Connections</a>; there is no separate plugin toggle.</p>
			<table class="wp-list-table widefat fixed striped">
				...
				<tbody>
					<?php foreach ( \StoryOS\Utils\Connection_Adapters::all() as $provider_type => $adapter ) : ?>
						<?php
						...
						$connections = \StoryOS\Utils\Connection_Repository::get_all( [ 'provider_type' => $provider_type ] );
						...
						<tr data-connection-adapter="<?php echo esc_attr( $provider_type ); ?>">
							...
							<td>
								...
								<?php endif; ?>
								<br><small><?php echo esc_html( \StoryOS\Utils\Connection_Adapters::is_loaded( $provider_type ) ? 'Loaded for this request' : 'Not loaded for this request' ); ?></small>
							</td>
							<td>
								<?php
								echo esc_html(
							...
							<td><a href="<?php echo esc_url( admin_url( 'admin.php?page=storyos-connections' ) ); ?>" class="button button-small"><?php echo esc_html( empty( $connections ) ? 'Add Connection' : 'Manage Connections' ); ?></a></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
