...
/**
 * Class Test_StoryOS_Relationship_Graph.
 */
class Test_StoryOS_Relationship_Graph extends TestCase {

	/**
	 * Analytics include totals and dashboard-ready entities.
	 */
	public function test_graph_analytics_match_dashboard_contract() {
		$analytics = \StoryOS\Utils\analyze_relationship_graph( $this->graph() );
	...
	public function test_character_network_includes_relationships_and_presence() {
		$network = \StoryOS\Utils\analyze_character_network( $this->graph() );
	...
	public function test_project_filter_prevents_cross_project_leakage() {
		$graph = $this->graph();
		$graph['nodes'][] = [ 'id' => 10, 'type' => 'storyos_project', 'title' => 'Project A' ];
		$graph['nodes'][] = [ 'id' => 11, 'type' => 'storyos_project', 'title' => 'Project B' ];
		$graph['nodes'][] = [ 'id' => 12, 'type' => 'storyos_story_world', 'title' => 'World A' ];
		$graph['nodes'][] = [ 'id' => 13, 'type' => 'storyos_story_world', 'title' => 'World B' ];
		...
		$filtered = \StoryOS\Utils\filter_relationship_graph_by_project( $graph, 10 );
	...
	private function graph(): array {
		return [
			'nodes' => [
				[ 'id' => 1, 'type' => 'storyos_character', 'title' => 'Ada' ],
				[ 'id' => 2, 'type' => 'storyos_character', 'title' => 'Ben' ],
				[ 'id' => 3, 'type' => 'storyos_scene', 'title' => 'The Arrival' ],
				[ 'id' => 4, 'type' => 'storyos_shot', 'title' => 'Close-up' ],
				[ 'id' => 5, 'type' => 'storyos_location', 'title' => 'Station' ],
			],
			'edges' => [
