...
**The open-source studio for worldbuilding, storytelling, and AI-powered
creative production.**
...
- Analyze stories with a Story Graph-aware AI Editor and 50+ specialist
  creative advisors.
- Check continuity, search across story entities, and explore relationship
  analytics.
- Configure template-backed image and audio generation workflows and retain
  returned media with provenance in WordPress.
...
- Import World Graph Studio project JSON and export Markdown screenplays or
  storyboards.
- Send supported entities to Celtx and parse or prepare EDL data using the
  included optional tools.
- Connect ComfyUI, Comfy Cloud, and supported AI providers without making one
  provider the owner of your project.

Additional file-based screenplay formats and professional script exporters are
on hold. That boundary does not affect the import, export, and synchronization
workflows already delivered. Google Web Stories connector source remains an
extension prototype rather than a marketed release feature.
...
- **Creator ownership.** World Graph Studio does not claim ownership of your
  ...
  apply.
- **Human-directed creativity.** AI advisors propose, analyze, and generate;
  creators decide what becomes part of the project.
